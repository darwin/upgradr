 ...
 * attached to bug report.
 */
BUGTRAP_API void APIENTRY BT_AddRegFile(LPCTSTR pszRegFile, PCTSTR pszRegKey);
/**
...
/**
 * @brief This function enumerates log file entires that will be attached to the report.
 */
 ...
 * @note Normally you should not call this function.
 */
BUGTRAP_API void APIENTRY BT_UinstallSehFilter(void);
